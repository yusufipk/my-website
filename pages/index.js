    ...
    <div>
      <div className="main">
        ...
        <p className="paragraph">
          ...
          open-source and technology in my Youtube channel. I have a podcast and
          I am writing blog.
        </p>
        ...
        <ol className="list">
          <li>
            🎤I love public speaking. It is a passion for me since my high
            school years.
          </li>
          <li>
          ...
          <li>
            🎹 I have been playing piano for 6 months and I enjoy singing.
          </li>
        </ol>
